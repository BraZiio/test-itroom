...
function Search() {
    ...
    const [datas, setDatas] = useState([]); //Stock data 
    const [searchTerm, setSearchTerm] = useState(""); //Stock search Terms
    ...
    // To retrieve the data entered in the search bar
    ...
    return (
        <div className="container-main">
            <div className="container-search">
                <h1 className="search-title">Ma super page de recheche</h1>
                ...
                <div className="search__results">
                    {datas.filter((val) => {
                        ...
                        return <div className="search__result" key={val.id}>
                                <div className="logo-result">
                                <svg id="default" xmlns="http://www.w3.org/2000/svg" width="93.833" height="75.702" viewBox="0 0 93.833 75.702">
